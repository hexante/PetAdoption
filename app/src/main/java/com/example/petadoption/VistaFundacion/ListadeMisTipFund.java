 ...
 */
public class ListadeMisTipFund extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_listade_mis_tip_fund, container, false);

        evrecyclerView = view.findViewById(R.id.RecyclertipFund);
